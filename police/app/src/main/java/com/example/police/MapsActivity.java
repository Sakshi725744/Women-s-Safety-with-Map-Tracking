...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("Location").child("latitude").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mDatabase.child("Location").child("longitude").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        mDatabase.child("Emergency").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                level = dataSnapshot.getValue(java.lang.String.class);
